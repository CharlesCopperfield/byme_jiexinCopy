...
<li id="back"><a href="#" onclick="formSubmit('../contract/list.action','_self');">返回</a></li>
</ul>
    </div>
</div>
</div>
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	       ...
	       <tr>
	            ...
	            <td class="tableContent"><textarea name="productDesc" rows="20" cols="10" style="width: 150px;height: 130px;"></textarea></td>
	       </tr>
		</table>
	</div>
</div>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>
			...
			<a href="../extCproduct/tocreate.action?contractProductId=${o.id }&contractId=${contractId}">[附件]</a>
		</td>
	</tr>
	</c:forEach>
