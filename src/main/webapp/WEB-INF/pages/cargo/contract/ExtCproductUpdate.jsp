...
<li id="back"><a href="../extCproduct/tocreate.action?contractId=${contractId }&contractProductId=${obj.contractProductId}">返回</a></li>
</ul>
    </div>
</div>
</div>
	            	...
	            	<select name="factoryId" onchange="setFactoryName(this.options[this.selectedIndex].text);">
	            		...
	            		<c:forEach items="${factoryList}" var="factory">
	            			<option value="${factory.id }"
	            				<c:if test="${factory.factoryName==obj.factoryName }">selected</c:if>
