    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td>
		            <input type="radio" name="printStyle" value="1" checked="checked">两款
		            <input type="radio" name="printStyle" value="2" >一款
	            </td>
	        </tr>
	        <tr>
	            ...
	            <td>
		            <input type="radio" name="importNum" value="3" checked="checked">★★★ 
	        ...
	        <tr>
	            ...
	            <td class="tableContent">
	            	<textarea name="crequest" rows="20" cols="10" style="width: 150px;height: 130px;"></textarea>
	            </td>
	            <td class="columnTitle_mustbe">说明：</td>
	            <td class="tableContent">
	            <textarea name="remark" rows="20" cols="10" style="width: 150px;height: 130px;"></textarea></td>
	        </tr>
