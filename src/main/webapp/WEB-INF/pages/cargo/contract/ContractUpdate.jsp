		...
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	         ...
	         <tr>
	            ...
	            <td>
		            <input type="radio" name="importNum" value="3" <c:if test="${obj.importNum == 3 }">checked</c:if>>★★★ 
		            <input type="radio" name="importNum" value="2" <c:if test="${obj.importNum == 2 }">checked</c:if>>★★
		            <input type="radio" name="importNum" value="1" <c:if test="${obj.importNum == 1 }">checked</c:if>>★
	            </td>
	        </tr>
	        <tr>
