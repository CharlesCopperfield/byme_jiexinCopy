...
public class ContractVO {
	...
	private List<ContractProductVO> contractProductVOs;//货物集合,一对多关系.
	public List<ContractProductVO> getContractProductVOs() {
		return contractProductVOs;
	}
	public void setContractProductVOs(List<ContractProductVO> contractProductVOs) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ContractVO other = (ContractVO) obj;
		if (contractNo == null) {
	...
	public ContractVO(String id, String offeror, String contractNo, Date signingDate, String inputBy, String checkBy,
